...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Strident Engine (Modified PE) v" + psychEngineVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("comic.ttf", 16, FlxColor.BLUE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
