...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		scoreTxt.setFormat(Paths.font("comic.ttf"), 20, FlxColor.BLUE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		if(SONG.credit != null) {
			...
			watermarkTxt.setFormat(Paths.font("comic.ttf"), 16, FlxColor.BLUE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		if(SONG.screwYou != null)
			{
				...
				screwYouTxt.setFormat(Paths.font("comic.ttf"), 16, FlxColor.BLUE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
				screwYouTxt.size = 18;
		...
		botplayTxt.setFormat(Paths.font("comic.ttf"), 40, FlxColor.BLUE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		sickCounterTxt.setFormat(Paths.font("comic.ttf"), 16, FlxColor.GREEN, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		goodCounterTxt.setFormat(Paths.font("comic.ttf"), 16, FlxColor.BLUE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		goodCounterTxt.size = 18;
		add(goodCounterTxt);
		badCounterTxt = new FlxText(10, FlxG.height - 164, 0, "Bads: " + badCounter, 50);
		badCounterTxt.scrollFactor.set();
		badCounterTxt.setFormat(Paths.font("comic.ttf"), 16, FlxColor.BLUE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		badCounterTxt.size = 18;
		add(badCounterTxt);
		shitCounterTxt = new FlxText(10, FlxG.height - 144, 0, "Shits: " + shitCounter, 50);
		shitCounterTxt.scrollFactor.set();
		shitCounterTxt.setFormat(Paths.font("comic.ttf"), 16, FlxColor.RED, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		shitCounterTxt.size = 18;
		add(shitCounterTxt);

		comboCounterTxt = new FlxText(10, FlxG.height - 244, 0, "Wombo Combo: " + combo, 70);
		comboCounterTxt.scrollFactor.set();
		comboCounterTxt.setFormat(Paths.font("comic.ttf"), 16, FlxColor.BLUE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		totalNotesTxt.setFormat(Paths.font("comic.ttf"), 16, FlxColor.BLUE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
Lib.application.window.resize(width, height);*/
		...
		comboCounterTxt.text = 'Wombo Combo: ' + combo;
		tnh = sickCounter + goodCounter + badCounter + shitCounter;
		totalNotesTxt.text = 'Total Notes Hit: ' + tnh;


		if(ratingString == '?') {
			scoreTxt.text = 'Reputation: ' + songScore + ' | Fuck Ups: ' + songMisses + ' | All-n-all: ' + ratingString;
		} else {
			scoreTxt.text = 'Reputation: ' + songScore + ' | Fuck Ups: ' + songMisses + ' | All-n-all: ' + ratingString + ' (' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%)' + ' - ' + ratingFC;
		}
	...
	public function RecalculateRating() {
		...
		setOnLuas('comboBreaks', songMisses);
