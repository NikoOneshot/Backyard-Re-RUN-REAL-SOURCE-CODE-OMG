...
class CharacterSelectionState extends MusicBeatState //This is not from the D&B source code, it's completely made by me (Delta). This also means I can use this code for other mods.
{
    ...
    override function create() 
    {
       ...
       curText.setFormat(Paths.font("comic.ttf"), 20, FlxColor.BLUE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
       curText.size = 50;
       
       characterText = new FlxText(10, 0, 0, 'Character', 20);
       characterText.setFormat(Paths.font("comic.ttf"), 20, FlxColor.BLUE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
