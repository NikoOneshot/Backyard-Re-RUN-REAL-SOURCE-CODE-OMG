...
HXDLIN(  13)		achievementsStuff = ::cpp::VirtualArray_obj::__new(16)->init(0,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Freaky on a Friday Night",ad,12,d0,d9))->init(1,HX_("Play on a Friday... Night.",1b,3d,4b,6e))->init(2,true))->init(1,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("She Calls Me Daddy Too",43,38,20,2e))->init(1,HX_("Beat Week 1 on Hard with no Misses.",3a,80,c0,14))->init(2,true))->init(2,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("No More Tricks",6c,b7,d5,1c))->init(1,HX_("Beat Week 2 on Hard with no Misses.",3b,bb,c7,1d))->init(2,true))->init(3,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Call Me The Hitman",fc,32,c3,c7))->init(1,HX_("Beat Week 3 on Hard with no Misses.",3c,f6,ce,26))->init(2,true))->init(4,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Lady Killer",a1,5f,9f,79))->init(1,HX_("Beat Week 4 on Hard with no Misses.",3d,31,d6,2f))->init(2,true))->init(5,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Missless Christmas",f7,6d,cc,37))->init(1,HX_("Beat Week 5 on Hard with no Misses.",3e,6c,dd,38))->init(2,true))->init(6,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Highscore!!",70,79,53,b1))->init(1,HX_("Beat Week 6 on Hard with no Misses.",3f,a7,e4,41))->init(2,true))->init(7,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("You'll Pay For That...",a0,91,89,56))->init(1,HX_("Beat Week 7 on Hard with no Misses.",40,e2,eb,4a))->init(2,true))->init(8,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("What a Funkin' Disaster!",9b,9a,f3,3d))->init(1,HX_("Complete a Song with a rating lower than 20%.",b8,88,a7,a1))->init(2,true))->init(9,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Perfectionist",2f,2d,d8,1a))->init(1,HX_("Complete a Song with a rating of 100%.",60,20,3e,99))->init(2,true))->init(10,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Roadkill Enthusiast",16,f9,a7,f4))->init(1,HX_("Watch the Henchmen die over 100 times.",23,f4,28,c4))->init(2,true))->init(11,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Oversinging Much...?",7f,24,1b,aa))->init(1,HX_("Hold down a note for 20 seconds.",88,fd,c0,47))->init(2,true))->init(12,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Hyperactive",12,ed,1a,97))->init(1,HX_("Finish a Song without going Idle.",3d,4e,8d,8b))->init(2,true))->init(13,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Just the Two of Us",f0,46,92,7c))->init(1,HX_("Finish a Song pressing only two keys.",34,0f,a6,8a))->init(2,true))->init(14,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Toaster Gamer",b4,2b,0d,33))->init(1,HX_("Have you tried to run the game on a toaster?",97,b9,bf,ff))->init(2,true))->init(15,::cpp::VirtualArray_obj::__new(3)->init(0,HX_("Debugger",41,e0,9c,6a))->init(1,HX_("Beat the \"Test\" Stage from the Chart Editor.",15,c5,9f,4a))->init(2,true));
            	}
{
