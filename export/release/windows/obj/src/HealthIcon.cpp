...
HXLINE(  40)				::String key1 = key;
HXDLIN(  40)				if (::hx::IsNull( key1 )) {
HXLINE(  40)					key1 = HX_("",00,00,00,00);
            				}
HXDLIN(  40)				_hx_tmp1 = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key1));
            			}
            			else {
...
HXLINE(  41)			::String key2 = ((HX_("images/",77,50,74,c1) + name) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  41)			bool _hx_tmp2;
HXDLIN(  41)			bool _hx_tmp3;
HXDLIN(  41)			::String key3 = ((::Paths_obj::currentModDirectory + HX_("/",2f,00,00,00)) + key2);
HXDLIN(  41)			if (::hx::IsNull( key3 )) {
HXLINE(  41)				key3 = HX_("",00,00,00,00);
            			}
HXDLIN(  41)			if (!(::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key3)))) {
HXLINE(  41)				::String key = key2;
HXDLIN(  41)				if (::hx::IsNull( key )) {
HXLINE(  41)					key = HX_("",00,00,00,00);
            				}
HXDLIN(  41)				_hx_tmp3 = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key));
            			}
            			else {
...
HXLINE(  41)				if (::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(key2,HX_("IMAGE",3b,57,57,3b),null()),null())) {
HXLINE(  41)					_hx_tmp2 = true;
            				}
            				else {
