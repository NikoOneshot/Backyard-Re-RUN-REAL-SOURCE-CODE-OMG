...
::FlxUIDropDownMenuDropDirection_obj::__register();
...
::__ASSET__assets_fonts_comic_ttf_obj::__register();
...
::FunkinLua_obj::__register();
::FreeplayState_obj::__register();
::FlxUIDropDownMenuCustom_obj::__register();
::FlashingState_obj::__register();
::DialogueBoxPsych_obj::__register();
::DialogueCharacter_obj::__register();
...
::AchievementsMenuState_obj::__register();
...
::editors::WeekEditorFreeplayState_obj::__register();
::editors::MenuCharacterEditorState_obj::__register();
::editors::MasterEditorMenu_obj::__register();
::editors::EditorPlayState_obj::__register();
::editors::AttachedFlxText_obj::__register();
::editors::CharacterEditorState_obj::__register();
...
::Std_obj::__register();
::Song_obj::__register();
::PulseShader_obj::__register();
::DistortBGShader_obj::__register();
::InvertShader_obj::__register();
::GlitchShader_obj::__register();
::InvertColorsEffect_obj::__register();
::DistortBGEffect_obj::__register();
::GlitchEffect_obj::__register();
::ResetScoreSubState_obj::__register();
::Reflect_obj::__register();
::flixel::util::_FlxSignal::FlxTypedSignal_Impl__obj::__register();
::PulseEffect_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_comic_ttf_obj::__register();
...
::InputFormatter_obj::__register();
::HealthIcon_obj::__register();
::GitarooPause_obj::__register();
::DebugLuaText_obj::__register();
::ModchartSprite_obj::__register();
::SongMetadata_obj::__register();
::FlxVideo_obj::__register();
::FlxUIDropDownHeader_obj::__register();
...
::AchievementObject_obj::__register();
::flixel::group::FlxTypedSpriteGroup_obj::__register();
::AttachedAchievement_obj::__register();
...
::FlxUIDropDownMenuDropDirection_obj::__boot();
...
::AchievementsMenuState_obj::__boot();
...
::DialogueCharacter_obj::__boot();
::DialogueBoxPsych_obj::__boot();
::FlashingState_obj::__boot();
::FlxUIDropDownMenuCustom_obj::__boot();
::FreeplayState_obj::__boot();
::FunkinLua_obj::__boot();
::flixel::text::FlxText_obj::__boot();
::GameOverSubstate_obj::__boot();
::Highscore_obj::__boot();
::LoadingState_obj::__boot();
::MainMenuState_obj::__boot();
::__ASSET__assets_fonts_comic_ttf_obj::__boot();
...
::Note_obj::__boot();
::OptionsState_obj::__boot();
::NotesSubstate_obj::__boot();
::ControlsSubstate_obj::__boot();
::PreferencesSubstate_obj::__boot();
::Paths_obj::__boot();
::PlayState_obj::__boot();
::PlayerSettings_obj::__boot();
::Section_obj::__boot();
::StageData_obj::__boot();
::StoryMenuState_obj::__boot();
::haxe::SysTools_obj::__boot();
::TitleState_obj::__boot();
::WeekData_obj::__boot();
::Xml_obj::__boot();
::editors::ChartingState_obj::__boot();
::editors::DialogueCharacterEditorState_obj::__boot();
