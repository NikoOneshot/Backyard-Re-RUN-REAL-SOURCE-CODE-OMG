...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_45_init,"Main","init",0xea732345,"Main.init","Main.hx",45,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_55_setupGame,"Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",55,0x087e5c05)
...
HXLINE(  19)		this->skipSplash = true;
...
HXLINE(  34)		if (::hx::IsNotNull( this->stage )) {
HXLINE(  36)			this->init(null());
            		}
            		else {
HXLINE(  40)			this->addEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null(),null(),null());
            		}
            	}
...
void Main_obj::init( ::openfl::events::Event E){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_45_init)
HXLINE(  46)		if (this->hasEventListener(HX_("addedToStage",63,22,55,0c))) {
HXLINE(  48)			this->removeEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null());
            		}
HXLINE(  51)		this->setupGame();
            	}
...
void Main_obj::setupGame(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_55_setupGame)
HXLINE(  56)		int stageWidth = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXLINE(  57)		int stageHeight = ::openfl::Lib_obj::get_current()->stage->stageHeight;
HXLINE(  59)		if ((this->zoom == -1)) {
HXLINE(  61)			Float ratioX = (( (Float)(stageWidth) ) / ( (Float)(this->gameWidth) ));
HXLINE(  62)			Float ratioY = (( (Float)(stageHeight) ) / ( (Float)(this->gameHeight) ));
HXLINE(  63)			this->zoom = ::Math_obj::min(ratioX,ratioY);
HXLINE(  64)			this->gameWidth = ::Math_obj::ceil((( (Float)(stageWidth) ) / this->zoom));
HXLINE(  65)			this->gameHeight = ::Math_obj::ceil((( (Float)(stageHeight) ) / this->zoom));
            		}
HXLINE(  69)		this->initialState = ::hx::ClassOf< ::TitleState >();
HXLINE(  72)		::Paths_obj::getModFolders();
...
HXLINE(  76)		::Main_obj::fpsVar =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  77)		this->addChild(::Main_obj::fpsVar);
HXLINE(  78)		if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE(  79)			::Main_obj::fpsVar->set_visible(::ClientPrefs_obj::showFPS);
            		}
            	}
...
void Main_obj::main(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_27_main)
HXDLIN(  27)		 ::openfl::display::MovieClip _hx_tmp = ::openfl::Lib_obj::get_current();
HXDLIN(  27)		_hx_tmp->addChild( ::Main_obj::__alloc( HX_CTX ));
            	}
