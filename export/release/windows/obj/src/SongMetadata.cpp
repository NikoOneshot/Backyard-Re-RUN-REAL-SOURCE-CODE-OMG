...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_403_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",403,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_403_new)
HXLINE( 409)		this->folder = HX_("",00,00,00,00);
HXLINE( 408)		this->color = -7179779;
HXLINE( 407)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 406)		this->week = 0;
HXLINE( 405)		this->songName = HX_("",00,00,00,00);
HXLINE( 413)		this->songName = song;
HXLINE( 414)		this->week = week;
HXLINE( 415)		this->songCharacter = songCharacter;
HXLINE( 416)		this->color = color;
HXLINE( 417)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 418)		if (::hx::IsNull( this->folder )) {
HXLINE( 418)			this->folder = HX_("",00,00,00,00);
            		}
            	}
