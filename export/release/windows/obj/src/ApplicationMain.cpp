...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("StridentEngine",e1,89,b8,ce),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("32",9f,2c,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Strident Engine",23,05,fc,b1));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("StridentEngine",e1,89,b8,ce));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Backyard Re-run (SE)",92,81,f9,bb));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.delta.stridentengine",a4,d2,13,78));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.1.0",75,ff,c8,c1));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': Backyard Re-run (SE)",92,81,f9,bb))
