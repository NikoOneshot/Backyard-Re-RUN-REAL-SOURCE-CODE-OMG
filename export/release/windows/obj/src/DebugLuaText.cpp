...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1425_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",1425,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1437_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",1437,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1425_new)
HXLINE(1427)		this->disableTime = ((Float)6);
HXLINE(1430)		this->parentGroup = parentGroup;
HXLINE(1431)		super::__construct(10,10,0,text,16,null());
HXLINE(1432)		this->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("comic.ttf",53,33,c3,2f)),20,-16776961,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(1433)		this->scrollFactor->set(null(),null());
HXLINE(1434)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1437_update)
HXLINE(1438)		this->super::update(elapsed);
HXLINE(1439)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1439)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(1440)		if ((this->disableTime <= 0)) {
HXLINE(1441)			this->kill();
HXLINE(1442)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(1443)			this->destroy();
            		}
            		else {
HXLINE(1445)			if ((this->disableTime < 1)) {
HXLINE(1445)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
