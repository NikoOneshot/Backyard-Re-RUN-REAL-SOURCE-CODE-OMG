...
HX_LOCAL_STACK_FRAME(_hx_pos_1f6708af66cddacf_320_updateOffset,"editors.MenuCharacterEditorState","updateOffset",0x1f04c7c8,"editors.MenuCharacterEditorState.updateOffset","editors/MenuCharacterEditorState.hx",320,0x22e068fb)
HX_LOCAL_STACK_FRAME(_hx_pos_1f6708af66cddacf_327_loadCharacter,"editors.MenuCharacterEditorState","loadCharacter",0x268e45d7,"editors.MenuCharacterEditorState.loadCharacter","editors/MenuCharacterEditorState.hx",327,0x22e068fb)
HX_LOCAL_STACK_FRAME(_hx_pos_1f6708af66cddacf_337_onLoadComplete,"editors.MenuCharacterEditorState","onLoadComplete",0x0c8fc10a,"editors.MenuCharacterEditorState.onLoadComplete","editors/MenuCharacterEditorState.hx",337,0x22e068fb)
HX_LOCAL_STACK_FRAME(_hx_pos_1f6708af66cddacf_377_onLoadCancel,"editors.MenuCharacterEditorState","onLoadCancel",0x04a4478b,"editors.MenuCharacterEditorState.onLoadCancel","editors/MenuCharacterEditorState.hx",377,0x22e068fb)
HX_LOCAL_STACK_FRAME(_hx_pos_1f6708af66cddacf_389_onLoadError,"editors.MenuCharacterEditorState","onLoadError",0xe4021ed7,"editors.MenuCharacterEditorState.onLoadError","editors/MenuCharacterEditorState.hx",389,0x22e068fb)
HX_LOCAL_STACK_FRAME(_hx_pos_1f6708af66cddacf_397_saveCharacter,"editors.MenuCharacterEditorState","saveCharacter",0xc8e2f9e0,"editors.MenuCharacterEditorState.saveCharacter","editors/MenuCharacterEditorState.hx",397,0x22e068fb)
HX_LOCAL_STACK_FRAME(_hx_pos_1f6708af66cddacf_413_onSaveComplete,"editors.MenuCharacterEditorState","onSaveComplete",0x65af2121,"editors.MenuCharacterEditorState.onSaveComplete","editors/MenuCharacterEditorState.hx",413,0x22e068fb)
HX_LOCAL_STACK_FRAME(_hx_pos_1f6708af66cddacf_425_onSaveCancel,"editors.MenuCharacterEditorState","onSaveCancel",0x9832a3e2,"editors.MenuCharacterEditorState.onSaveCancel","editors/MenuCharacterEditorState.hx",425,0x22e068fb)
HX_LOCAL_STACK_FRAME(_hx_pos_1f6708af66cddacf_436_onSaveError,"editors.MenuCharacterEditorState","onSaveError",0x5777da60,"editors.MenuCharacterEditorState.onSaveError","editors/MenuCharacterEditorState.hx",436,0x22e068fb)
namespace editors{
...
HXLINE( 283)				::MusicBeatState_obj::switchState( ::editors::MasterEditorMenu_obj::__alloc( HX_CTX ,null(),null()));
HXLINE( 284)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 284)				::String library = null();
HXDLIN( 284)				::String file = ::Paths_obj::modFolders((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN( 284)				 ::Dynamic _hx_tmp1;
HXDLIN( 284)				if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 284)					if (!(::Paths_obj::customSoundsLoaded->exists(file))) {
HXLINE( 284)						::Dynamic this1 = ::Paths_obj::customSoundsLoaded;
HXDLIN( 284)						( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            					}
HXDLIN( 284)					_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            				}
            				else {
HXLINE( 284)					_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            				}
HXDLIN( 284)				_hx_tmp->playMusic(_hx_tmp1,null(),null(),null());
            			}
HXLINE( 287)			int shiftMult = 1;
HXLINE( 288)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 288)			if (_this1->keyManager->checkStatus(16,_this1->status)) {
HXLINE( 288)				shiftMult = 10;
            			}
HXLINE( 290)			 ::flixel::input::keyboard::FlxKeyList _this2 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 290)			if (_this2->keyManager->checkStatus(37,_this2->status)) {
HXLINE( 291)				::Array< int > base = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 291)				int _hx_tmp = 0;
HXDLIN( 291)				base[_hx_tmp] = (base->__get(_hx_tmp) + shiftMult);
HXLINE( 292)				this->updateOffset();
            			}
HXLINE( 294)			 ::flixel::input::keyboard::FlxKeyList _this3 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 294)			if (_this3->keyManager->checkStatus(39,_this3->status)) {
HXLINE( 295)				::Array< int > base = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 295)				int _hx_tmp = 0;
HXDLIN( 295)				base[_hx_tmp] = (base->__get(_hx_tmp) - shiftMult);
HXLINE( 296)				this->updateOffset();
            			}
HXLINE( 298)			 ::flixel::input::keyboard::FlxKeyList _this4 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 298)			if (_this4->keyManager->checkStatus(38,_this4->status)) {
HXLINE( 299)				::Array< int > base = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 299)				int _hx_tmp = 1;
HXDLIN( 299)				base[_hx_tmp] = (base->__get(_hx_tmp) + shiftMult);
HXLINE( 300)				this->updateOffset();
            			}
HXLINE( 302)			 ::flixel::input::keyboard::FlxKeyList _this5 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 302)			if (_this5->keyManager->checkStatus(40,_this5->status)) {
HXLINE( 303)				::Array< int > base = ( (::Array< int >)(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXDLIN( 303)				int _hx_tmp = 1;
HXDLIN( 303)				base[_hx_tmp] = (base->__get(_hx_tmp) - shiftMult);
HXLINE( 304)				this->updateOffset();
            			}
HXLINE( 307)			bool _hx_tmp;
HXDLIN( 307)			 ::flixel::input::keyboard::FlxKeyList _this6 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 307)			if (_this6->keyManager->checkStatus(32,_this6->status)) {
HXLINE( 307)				_hx_tmp = (this->curTypeSelected == 1);
            			}
            			else {
HXLINE( 307)				_hx_tmp = false;
            			}
HXDLIN( 307)			if (_hx_tmp) {
HXLINE( 308)				Dynamic( this->grpWeekCharacters->members->__get(this->curTypeSelected)).StaticCast<  ::MenuCharacter >()->animation->play(HX_("confirm",00,9d,39,10),true,null(),null());
            			}
            		}
HXLINE( 312)		 ::MenuCharacter _hx_char = Dynamic( this->grpWeekCharacters->members->__get(1)).StaticCast<  ::MenuCharacter >();
HXLINE( 313)		bool _hx_tmp;
HXDLIN( 313)		bool _hx_tmp1;
HXDLIN( 313)		if (::hx::IsNotNull( _hx_char->animation->_curAnim )) {
HXLINE( 313)			_hx_tmp1 = (_hx_char->animation->_curAnim->name == HX_("confirm",00,9d,39,10));
            		}
            		else {
HXLINE( 313)			_hx_tmp1 = false;
            		}
HXDLIN( 313)		if (_hx_tmp1) {
HXLINE( 313)			_hx_tmp = _hx_char->animation->_curAnim->finished;
            		}
            		else {
HXLINE( 313)			_hx_tmp = false;
            		}
HXDLIN( 313)		if (_hx_tmp) {
HXLINE( 314)			_hx_char->animation->play(HX_("idle",14,a7,b3,45),true,null(),null());
            		}
...
void MenuCharacterEditorState_obj::updateOffset(){
            	HX_STACKFRAME(&_hx_pos_1f6708af66cddacf_320_updateOffset)
HXLINE( 321)		 ::MenuCharacter _hx_char = Dynamic( this->grpWeekCharacters->members->__get(this->curTypeSelected)).StaticCast<  ::MenuCharacter >();
HXLINE( 322)		_hx_char->offset->set( ::Dynamic(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(0), ::Dynamic(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(1));
HXLINE( 323)		 ::flixel::text::FlxText _hx_tmp = this->txtOffsets;
HXDLIN( 323)		_hx_tmp->set_text((HX_("",00,00,00,00) + ::Std_obj::string( ::Dynamic(this->characterFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)))));
            	}
...
void MenuCharacterEditorState_obj::loadCharacter(){
            	HX_GC_STACKFRAME(&_hx_pos_1f6708af66cddacf_327_loadCharacter)
HXLINE( 328)		 ::openfl::net::FileFilter jsonFilter =  ::openfl::net::FileFilter_obj::__alloc( HX_CTX ,HX_("JSON",28,0a,29,31),HX_("json",28,42,68,46),null());
HXLINE( 329)		this->_file =  ::openfl::net::FileReference_obj::__alloc( HX_CTX );
HXLINE( 330)		this->_file->addEventListener(HX_("select",fc,1a,33,6a),this->onLoadComplete_dyn(),null(),null(),null());
HXLINE( 331)		this->_file->addEventListener(HX_("cancel",7a,ed,33,b8),this->onLoadCancel_dyn(),null(),null(),null());
HXLINE( 332)		this->_file->addEventListener(HX_("ioError",02,fe,41,76),this->onLoadError_dyn(),null(),null(),null());
HXLINE( 333)		this->_file->browse(::Array_obj< ::Dynamic>::__new(1)->init(0,jsonFilter));
            	}
...
void MenuCharacterEditorState_obj::onLoadComplete( ::openfl::events::Event _){
            	HX_GC_STACKFRAME(&_hx_pos_1f6708af66cddacf_337_onLoadComplete)
HXLINE( 338)		this->_file->removeEventListener(HX_("select",fc,1a,33,6a),this->onLoadComplete_dyn(),null());
HXLINE( 339)		this->_file->removeEventListener(HX_("cancel",7a,ed,33,b8),this->onLoadCancel_dyn(),null());
HXLINE( 340)		this->_file->removeEventListener(HX_("ioError",02,fe,41,76),this->onLoadError_dyn(),null());
HXLINE( 343)		::String fullPath = null();
HXLINE( 344)		 ::Dynamic replacer = null();
HXDLIN( 344)		::String space = null();
HXDLIN( 344)		 ::Dynamic jsonLoaded =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,::haxe::format::JsonPrinter_obj::print(this->_file,replacer,space))->doParse();
HXLINE( 345)		if (::hx::IsNotNull( jsonLoaded->__Field(HX_("__path",c5,48,4a,f9),::hx::paccDynamic) )) {
HXLINE( 345)			fullPath = ( (::String)(jsonLoaded->__Field(HX_("__path",c5,48,4a,f9),::hx::paccDynamic)) );
            		}
HXLINE( 347)		if (::hx::IsNotNull( fullPath )) {
HXLINE( 348)			::String rawJson = ::sys::io::File_obj::getContent(fullPath);
HXLINE( 349)			if (::hx::IsNotNull( rawJson )) {
HXLINE( 350)				 ::Dynamic loadedChar =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 351)				bool _hx_tmp;
HXDLIN( 351)				if (::hx::IsNotNull( loadedChar->__Field(HX_("idle_anim",5c,d2,54,bd),::hx::paccDynamic) )) {
HXLINE( 351)					_hx_tmp = ::hx::IsNotNull( loadedChar->__Field(HX_("confirm_anim",f0,e4,4f,7c),::hx::paccDynamic) );
            				}
            				else {
HXLINE( 351)					_hx_tmp = false;
            				}
HXDLIN( 351)				if (_hx_tmp) {
HXLINE( 353)					::String cutName = this->_file->name.substr(0,(this->_file->name.length - 5));
HXLINE( 354)					::haxe::Log_obj::trace((HX_("Successfully loaded file: ",84,24,61,ed) + cutName),::hx::SourceInfo(HX_("source/editors/MenuCharacterEditorState.hx",87,da,fd,31),354,HX_("editors.MenuCharacterEditorState",a2,06,38,48),HX_("onLoadComplete",be,4c,20,63)));
HXLINE( 355)					this->characterFile = loadedChar;
HXLINE( 356)					this->reloadSelectedCharacter();
HXLINE( 357)					this->imageInputText->set_text(( (::String)(this->characterFile->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) ));
HXLINE( 358)					this->idleInputText->set_text(( (::String)(this->characterFile->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) ));
HXLINE( 359)					this->confirmInputText->set_text(( (::String)(this->characterFile->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) ));
HXLINE( 360)					this->scaleStepper->set_value(( (Float)(this->characterFile->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic)) ));
HXLINE( 361)					this->updateOffset();
HXLINE( 362)					this->_file = null();
HXLINE( 363)					return;
            				}
            			}
            		}
...
void MenuCharacterEditorState_obj::onLoadCancel( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_1f6708af66cddacf_377_onLoadCancel)
...
HXLINE( 382)		::haxe::Log_obj::trace(HX_("Cancelled file loading.",67,56,c5,a3),::hx::SourceInfo(HX_("source/editors/MenuCharacterEditorState.hx",87,da,fd,31),382,HX_("editors.MenuCharacterEditorState",a2,06,38,48),HX_("onLoadCancel",3f,be,a2,45)));
            	}
...
void MenuCharacterEditorState_obj::onLoadError( ::openfl::events::IOErrorEvent _){
            	HX_STACKFRAME(&_hx_pos_1f6708af66cddacf_389_onLoadError)
HXLINE( 390)		this->_file->removeEventListener(HX_("select",fc,1a,33,6a),this->onLoadComplete_dyn(),null());
HXLINE( 391)		this->_file->removeEventListener(HX_("cancel",7a,ed,33,b8),this->onLoadCancel_dyn(),null());
HXLINE( 392)		this->_file->removeEventListener(HX_("ioError",02,fe,41,76),this->onLoadError_dyn(),null());
HXLINE( 393)		this->_file = null();
HXLINE( 394)		::haxe::Log_obj::trace(HX_("Problem loading file",21,8c,56,d8),::hx::SourceInfo(HX_("source/editors/MenuCharacterEditorState.hx",87,da,fd,31),394,HX_("editors.MenuCharacterEditorState",a2,06,38,48),HX_("onLoadError",a3,fa,a3,b0)));
            	}
...
void MenuCharacterEditorState_obj::saveCharacter(){
            	HX_GC_STACKFRAME(&_hx_pos_1f6708af66cddacf_397_saveCharacter)
HXLINE( 398)		 ::Dynamic replacer = null();
HXDLIN( 398)		::String data = ::haxe::format::JsonPrinter_obj::print(this->characterFile,replacer,HX_("\t",09,00,00,00));
HXLINE( 399)		if ((data.length > 0)) {
HXLINE( 401)			::Array< ::String > splittedImage = ::StringTools_obj::trim(this->imageInputText->text).split(HX_("_",5f,00,00,00));
HXLINE( 402)			::String characterName = ::StringTools_obj::replace(splittedImage->__get((splittedImage->length - 1)).toLowerCase(),HX_(" ",20,00,00,00),HX_("",00,00,00,00));
HXLINE( 404)			this->_file =  ::openfl::net::FileReference_obj::__alloc( HX_CTX );
HXLINE( 405)			this->_file->addEventListener(HX_("complete",b9,00,c8,7f),this->onSaveComplete_dyn(),null(),null(),null());
HXLINE( 406)			this->_file->addEventListener(HX_("cancel",7a,ed,33,b8),this->onSaveCancel_dyn(),null(),null(),null());
HXLINE( 407)			this->_file->addEventListener(HX_("ioError",02,fe,41,76),this->onSaveError_dyn(),null(),null(),null());
HXLINE( 408)			this->_file->save(data,(characterName + HX_(".json",56,f1,d6,c2)));
            		}
            	}
...
void MenuCharacterEditorState_obj::onSaveComplete( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_1f6708af66cddacf_413_onSaveComplete)
...
void MenuCharacterEditorState_obj::onSaveCancel( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_1f6708af66cddacf_425_onSaveCancel)
HXLINE( 426)		this->_file->removeEventListener(HX_("complete",b9,00,c8,7f),this->onSaveComplete_dyn(),null());
HXLINE( 427)		this->_file->removeEventListener(HX_("cancel",7a,ed,33,b8),this->onSaveCancel_dyn(),null());
HXLINE( 428)		this->_file->removeEventListener(HX_("ioError",02,fe,41,76),this->onSaveError_dyn(),null());
HXLINE( 429)		this->_file = null();
            	}
...
void MenuCharacterEditorState_obj::onSaveError( ::openfl::events::IOErrorEvent _){
            	HX_STACKFRAME(&_hx_pos_1f6708af66cddacf_436_onSaveError)
HXLINE( 437)		this->_file->removeEventListener(HX_("complete",b9,00,c8,7f),this->onSaveComplete_dyn(),null());
HXLINE( 438)		this->_file->removeEventListener(HX_("cancel",7a,ed,33,b8),this->onSaveCancel_dyn(),null());
HXLINE( 439)		this->_file->removeEventListener(HX_("ioError",02,fe,41,76),this->onSaveError_dyn(),null());
HXLINE( 440)		this->_file = null();
            	}
