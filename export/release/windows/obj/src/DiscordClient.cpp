...
HXLINE(  13)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("982786129172500480",8d,7a,80,42))
...
HXDLIN(  38)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("state",11,76,0b,84),HX_("Webhook for the fan-mod, Backyard Re-run.",4b,aa,95,9f))
            			->setFixed(1,HX_("details",c2,dc,56,ab),HX_("In the Menus",0a,c1,ad,c6))
            			->setFixed(2,HX_("largeImageKey",df,8f,e3,ae),HX_("logo",6b,9f,b7,47))
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("Dave & Bambi: Backyard Re-run",63,28,f3,90))));
            	}
...
HXLINE(  78)		::String _hx_tmp = (HX_("Engine Version: ",e0,15,79,71) + ::MainMenuState_obj::psychEngineVersion);
HXLINE(  81)		 ::Dynamic _hx_tmp1 = ::Std_obj::_hx_int((startTimestamp / ( (Float)(1000) )));
HXLINE(  74)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(7)
            			...
            			->setFixed(3,HX_("largeImageKey",df,8f,e3,ae),HX_("logo",6b,9f,b7,47))
