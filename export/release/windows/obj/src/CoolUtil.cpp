...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_56_textFile,"CoolUtil","textFile",0x7a4f230c,"CoolUtil.textFile","CoolUtil.hx",56,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_68_numberArray,"CoolUtil","numberArray",0x9e0008ad,"CoolUtil.numberArray","CoolUtil.hx",68,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_79_precacheSound,"CoolUtil","precacheSound",0x516888ed,"CoolUtil.precacheSound","CoolUtil.hx",79,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_88_browserLoad,"CoolUtil","browserLoad",0xdac4a08b,"CoolUtil.browserLoad","CoolUtil.hx",88,0x9f143813)
...
::String CoolUtil_obj::textFile(::String path){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_56_textFile)
HXLINE(  57)		::String text = HX_("",00,00,00,00);
HXLINE(  59)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE(  59)			text = ::sys::io::File_obj::getContent(path);
            		}
HXLINE(  64)		return text;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(CoolUtil_obj,textFile,return )

::Array< int > CoolUtil_obj::numberArray(int max, ::Dynamic __o_min){
            		 ::Dynamic min = __o_min;
            		if (::hx::IsNull(__o_min)) min = 0;
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_68_numberArray)
HXLINE(  69)		::Array< int > dumbArray = ::Array_obj< int >::__new(0);
HXLINE(  70)		{
HXLINE(  70)			int _g = ( (int)(min) );
HXDLIN(  70)			int _g1 = max;
HXDLIN(  70)			while((_g < _g1)){
HXLINE(  70)				_g = (_g + 1);
HXDLIN(  70)				int i = (_g - 1);
HXLINE(  72)				dumbArray->push(i);
            			}
            		}
HXLINE(  74)		return dumbArray;
            	}
...
void CoolUtil_obj::precacheSound(::String sound,::String library){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_79_precacheSound)
HXDLIN(  79)		::Dynamic _hx_tmp = ::openfl::utils::Assets_obj::cache;
HXDLIN(  79)		if (!(::openfl::utils::IAssetCache_obj::hasSound(_hx_tmp,::Paths_obj::sound(sound,library)))) {
HXLINE(  80)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _this = ::flixel::FlxG_obj::sound;
HXDLIN(  80)			::String EmbeddedSound = ( (::String)(::Paths_obj::sound(sound,library)) );
HXDLIN(  80)			bool _hx_tmp;
HXDLIN(  80)			if (!(::openfl::utils::Assets_obj::exists(EmbeddedSound,HX_("SOUND",af,c4,ba,fe)))) {
HXLINE(  80)				_hx_tmp = ::openfl::utils::Assets_obj::exists(EmbeddedSound,HX_("MUSIC",85,08,49,8e));
            			}
            			else {
HXLINE(  80)				_hx_tmp = true;
            			}
HXDLIN(  80)			if (_hx_tmp) {
HXLINE(  80)				::openfl::utils::Assets_obj::getSound(EmbeddedSound,true);
            			}
            		}
            	}
...
void CoolUtil_obj::browserLoad(::String site){
            	HX_GC_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_88_browserLoad)
HXDLIN(  88)		::String prefix = HX_("",00,00,00,00);
HXDLIN(  88)		if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(site))) {
HXDLIN(  88)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXDLIN(  88)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + site)),HX_("_blank",95,26,d9,b0));
            	}
...
bool CoolUtil_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"textFile") ) { outValue = textFile_dyn(); return true; }
		break;
	case 11:
