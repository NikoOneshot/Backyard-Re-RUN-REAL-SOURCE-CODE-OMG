...
HXLINE( 648)		if (::hx::IsInstanceNotEq( this->get_camera(),Value )) {
...
HXLINE( 655)		if (::hx::IsPointerNotEq( this->get_cameras(),Value )) {
...
HXLINE( 737)		int Value = _tmp_Value;
...
HXDLIN( 894)		Sprite->set_x((Sprite->x + X));
            	}
...
HXDLIN( 897)		Sprite->set_y((Sprite->y + Y));
            	}
...
HXDLIN( 900)		Sprite->set_angle((Sprite->angle + Angle));
            	}
...
HXLINE( 905)			Sprite->set_alpha((Sprite->alpha * Alpha));
            		}
            		else {
