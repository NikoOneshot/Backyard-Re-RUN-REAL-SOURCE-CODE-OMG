...
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_233_applyMarkup,"flixel.addons.text.FlxTypeText","applyMarkup",0x7596b149,"flixel.addons.text.FlxTypeText.applyMarkup","flixel/addons/text/FlxTypeText.hx",233,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_244_insertBreakLines,"flixel.addons.text.FlxTypeText","insertBreakLines",0x530ffae6,"flixel.addons.text.FlxTypeText.insertBreakLines","flixel/addons/text/FlxTypeText.hx",244,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_285_erase,"flixel.addons.text.FlxTypeText","erase",0x8c731639,"flixel.addons.text.FlxTypeText.erase","flixel/addons/text/FlxTypeText.hx",285,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_321_resetText,"flixel.addons.text.FlxTypeText","resetText",0xe198a8ef,"flixel.addons.text.FlxTypeText.resetText","flixel/addons/text/FlxTypeText.hx",321,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_340_setTypingVariation,"flixel.addons.text.FlxTypeText","setTypingVariation",0x5d85e3a7,"flixel.addons.text.FlxTypeText.setTypingVariation","flixel/addons/text/FlxTypeText.hx",340,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_349_onComplete,"flixel.addons.text.FlxTypeText","onComplete",0xeb447ac5,"flixel.addons.text.FlxTypeText.onComplete","flixel/addons/text/FlxTypeText.hx",349,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_382_onErased,"flixel.addons.text.FlxTypeText","onErased",0xfbbc7fca,"flixel.addons.text.FlxTypeText.onErased","flixel/addons/text/FlxTypeText.hx",382,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_393_update,"flixel.addons.text.FlxTypeText","update",0x99170156,"flixel.addons.text.FlxTypeText.update","flixel/addons/text/FlxTypeText.hx",393,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_531_skip,"flixel.addons.text.FlxTypeText","skip",0x2e99348c,"flixel.addons.text.FlxTypeText.skip","flixel/addons/text/FlxTypeText.hx",531,0x9451ed7e)
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_545_loadDefaultSound,"flixel.addons.text.FlxTypeText","loadDefaultSound",0xf442cd21,"flixel.addons.text.FlxTypeText.loadDefaultSound","flixel/addons/text/FlxTypeText.hx",545,0x9451ed7e)
...
HXLINE( 219)		if (::hx::IsNotNull( Callback )) {
HXLINE( 221)			this->completeCallback = Callback;
            		}
HXLINE( 224)		this->insertBreakLines();
HXLINE( 226)		if (this->useDefaultSound) {
HXLINE( 228)			this->loadDefaultSound();
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC5(FlxTypeText_obj,start,(void))
 ...
 ::flixel::text::FlxText FlxTypeText_obj::applyMarkup(::String input,::Array< ::Dynamic> rules){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_233_applyMarkup)
HXLINE( 234)		this->super::applyMarkup(input,rules);
HXLINE( 235)		this->resetText(this->text);
HXLINE( 236)		return ::hx::ObjectPtr<OBJ_>(this);
            	}


void FlxTypeText_obj::insertBreakLines(){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_244_insertBreakLines)
HXLINE( 245)		::String saveText = this->text;
HXLINE( 247)		int last = this->_finalText.length;
HXLINE( 248)		int n0 = 0;
HXLINE( 249)		int n1 = 0;
HXLINE( 251)		while(true){
HXLINE( 253)			last = this->_finalText.substr(0,last).lastIndexOf(HX_(" ",20,00,00,00),null());
HXLINE( 255)			if ((last <= 0)) {
HXLINE( 256)				goto _hx_goto_3;
            			}
HXLINE( 258)			this->set_text((this->prefix + this->_finalText));
HXLINE( 259)			n0 = this->textField->get_numLines();
HXLINE( 261)			::String nextText = (this->_finalText.substr(0,last) + HX_("\n",0a,00,00,00));
HXDLIN( 261)			::String nextText1 = (nextText + this->_finalText.substr((last + 1),this->_finalText.length));
HXLINE( 263)			this->set_text((this->prefix + nextText1));
HXLINE( 264)			n1 = this->textField->get_numLines();
HXLINE( 266)			if ((n0 == n1)) {
HXLINE( 268)				this->_finalText = nextText1;
            			}
            		}
            		_hx_goto_3:;
HXLINE( 272)		this->set_text(saveText);
            	}
...
void FlxTypeText_obj::erase( ::Dynamic Delay,::hx::Null< bool >  __o_ForceRestart,::Array< int > SkipKeys, ::Dynamic Callback){
            		bool ForceRestart = __o_ForceRestart.Default(false);
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_285_erase)
HXLINE( 286)		this->_erasing = true;
HXLINE( 287)		this->_typing = false;
HXLINE( 288)		this->paused = false;
HXLINE( 289)		this->_waiting = false;
HXLINE( 291)		if (::hx::IsNotNull( Delay )) {
HXLINE( 293)			this->eraseDelay = ( (Float)(Delay) );
            		}
HXLINE( 296)		if (ForceRestart) {
HXLINE( 298)			this->_length = this->_finalText.length;
HXLINE( 299)			this->set_text(this->_finalText);
            		}
HXLINE( 302)		if (::hx::IsNotNull( SkipKeys )) {
HXLINE( 304)			this->skipKeys = SkipKeys;
            		}
HXLINE( 307)		this->eraseCallback = Callback;
HXLINE( 309)		if (this->useDefaultSound) {
HXLINE( 311)			this->loadDefaultSound();
            		}
            	}
...
void FlxTypeText_obj::resetText(::String Text){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_321_resetText)
HXLINE( 322)		this->set_text(HX_("",00,00,00,00));
HXLINE( 323)		this->_finalText = Text;
HXLINE( 324)		this->_typing = false;
HXLINE( 325)		this->_erasing = false;
HXLINE( 326)		this->paused = false;
HXLINE( 327)		this->_waiting = false;
HXLINE( 328)		this->_length = 0;
            	}
...
void FlxTypeText_obj::setTypingVariation(::hx::Null< Float >  __o_Amount,::hx::Null< bool >  __o_On){
            	...
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_340_setTypingVariation)
HXLINE( 341)		this->_typingVariation = On;
HXLINE( 342)		Float lowerBound;
HXDLIN( 342)		if ((Amount < 0)) {
HXLINE( 342)			lowerBound = ( (Float)(0) );
            		}
            		else {
HXLINE( 342)			lowerBound = Amount;
            		}
HXDLIN( 342)		Float _hx_tmp;
HXDLIN( 342)		if ((lowerBound > 1)) {
HXLINE( 342)			_hx_tmp = ( (Float)(1) );
            		}
            		else {
HXLINE( 342)			_hx_tmp = lowerBound;
            		}
HXDLIN( 342)		this->_typeVarPercent = _hx_tmp;
            	}
...
void FlxTypeText_obj::onComplete(){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_349_onComplete)
HXLINE( 350)		this->_timer = ( (Float)(0) );
HXLINE( 351)		this->_typing = false;
HXLINE( 353)		if (this->useDefaultSound) {
HXLINE( 355)			 ::flixel::_hx_system::FlxSound _this = this->_sound;
HXDLIN( 355)			_this->cleanup(_this->autoDestroy,true);
            		}
            		else {
HXLINE( 357)			if (::hx::IsNotNull( this->sounds )) {
HXLINE( 359)				int _g = 0;
HXDLIN( 359)				::Array< ::Dynamic> _g1 = this->sounds;
...
HXDLIN( 359)					_g = (_g + 1);
HXLINE( 361)					sound->cleanup(sound->autoDestroy,true);
            				}
            			}
            		}
HXLINE( 365)		if (::hx::IsNotNull( this->completeCallback )) {
HXLINE( 367)			this->completeCallback();
            		}
HXLINE( 370)		bool _hx_tmp;
HXDLIN( 370)		if (this->autoErase) {
HXLINE( 370)			_hx_tmp = (this->waitTime <= 0);
            		}
            		else {
...
HXLINE( 374)			if (this->autoErase) {
HXLINE( 376)				this->_waitTimer = this->waitTime;
HXLINE( 377)				this->_waiting = true;
            			}
            		}
            	}
...
void FlxTypeText_obj::onErased(){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_382_onErased)
HXLINE( 383)		this->_timer = ( (Float)(0) );
HXLINE( 384)		this->_erasing = false;
HXLINE( 386)		if (::hx::IsNotNull( this->eraseCallback )) {
HXLINE( 388)			this->eraseCallback();
            		}
            	}
...
void FlxTypeText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_393_update)
HXLINE( 396)		bool _hx_tmp;
HXDLIN( 396)		bool _hx_tmp1;
HXDLIN( 396)		if (::hx::IsNotNull( this->skipKeys )) {
HXLINE( 396)			_hx_tmp1 = (this->skipKeys->length > 0);
            		}
            		else {
HXLINE( 396)			_hx_tmp1 = false;
            		}
HXDLIN( 396)		if (_hx_tmp1) {
HXLINE( 396)			_hx_tmp = ::flixel::FlxG_obj::keys->checkKeyArrayState(this->skipKeys,2);
            		}
            		else {
HXLINE( 396)			_hx_tmp = false;
            		}
HXDLIN( 396)		if (_hx_tmp) {
HXLINE( 398)			this->skip();
            		}
HXLINE( 402)		bool _hx_tmp2;
HXDLIN( 402)		if (this->_waiting) {
HXLINE( 402)			_hx_tmp2 = !(this->paused);
            		}
            		else {
HXLINE( 402)			_hx_tmp2 = false;
            		}
HXDLIN( 402)		if (_hx_tmp2) {
HXLINE( 404)			 ::flixel::addons::text::FlxTypeText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 404)			_hx_tmp->_waitTimer = (_hx_tmp->_waitTimer - elapsed);
HXLINE( 406)			if ((this->_waitTimer <= 0)) {
HXLINE( 408)				this->_waiting = false;
HXLINE( 409)				this->_erasing = true;
            			}
            		}
HXLINE( 414)		bool _hx_tmp3;
HXDLIN( 414)		if (!(this->_waiting)) {
HXLINE( 414)			_hx_tmp3 = !(this->paused);
            		}
            		else {
...
HXDLIN( 416)			if ((this->_length < this->_finalText.length)) {
HXLINE( 416)				_hx_tmp = this->_typing;
            			}
            			else {
HXLINE( 416)				_hx_tmp = false;
            			}
HXDLIN( 416)			if (_hx_tmp) {
HXLINE( 418)				 ::flixel::addons::text::FlxTypeText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 418)				_hx_tmp->_timer = (_hx_tmp->_timer + elapsed);
            			}
HXLINE( 421)			bool _hx_tmp1;
HXDLIN( 421)			if ((this->_length > 0)) {
HXLINE( 421)				_hx_tmp1 = this->_erasing;
            			}
            			else {
HXLINE( 421)				_hx_tmp1 = false;
            			}
HXDLIN( 421)			if (_hx_tmp1) {
HXLINE( 423)				 ::flixel::addons::text::FlxTypeText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 423)				_hx_tmp->_timer = (_hx_tmp->_timer + elapsed);
            			}
            		}
HXLINE( 429)		bool _hx_tmp4;
HXDLIN( 429)		if (!(this->_typing)) {
HXLINE( 429)			_hx_tmp4 = this->_erasing;
            		}
            		else {
...
HXDLIN( 431)			if (this->_typing) {
HXLINE( 431)				_hx_tmp = (this->_timer >= this->delay);
            			}
            			else {
HXLINE( 431)				_hx_tmp = false;
            			}
HXDLIN( 431)			if (_hx_tmp) {
HXLINE( 433)				 ::flixel::addons::text::FlxTypeText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 433)				int _hx_tmp1 = _hx_tmp->_length;
HXDLIN( 433)				_hx_tmp->_length = (_hx_tmp1 + ::Std_obj::_hx_int((this->_timer / this->delay)));
HXLINE( 434)				if ((this->_length > this->_finalText.length)) {
HXLINE( 435)					this->_length = this->_finalText.length;
            				}
            			}
HXLINE( 438)			bool _hx_tmp1;
HXDLIN( 438)			if (this->_erasing) {
HXLINE( 438)				_hx_tmp1 = (this->_timer >= this->eraseDelay);
            			}
            			else {
HXLINE( 438)				_hx_tmp1 = false;
            			}
HXDLIN( 438)			if (_hx_tmp1) {
HXLINE( 440)				 ::flixel::addons::text::FlxTypeText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 440)				int _hx_tmp1 = _hx_tmp->_length;
HXDLIN( 440)				_hx_tmp->_length = (_hx_tmp1 - ::Std_obj::_hx_int((this->_timer / this->eraseDelay)));
HXLINE( 441)				if ((this->_length < 0)) {
HXLINE( 442)					this->_length = 0;
            				}
            			}
HXLINE( 445)			bool _hx_tmp2;
HXDLIN( 445)			bool _hx_tmp3;
HXDLIN( 445)			if (this->_typing) {
HXLINE( 445)				_hx_tmp3 = (this->_timer >= this->delay);
            			}
            			else {
HXLINE( 445)				_hx_tmp3 = false;
            			}
HXDLIN( 445)			if (!(_hx_tmp3)) {
HXLINE( 445)				if (this->_erasing) {
HXLINE( 445)					_hx_tmp2 = (this->_timer >= this->eraseDelay);
            				}
            				else {
...
HXLINE( 447)				if (this->_typingVariation) {
HXLINE( 449)					if (this->_typing) {
HXLINE( 451)						this->_timer = ::flixel::FlxG_obj::random->_hx_float(((-(this->delay) * this->_typeVarPercent) / ( (Float)(2) )),((this->delay * this->_typeVarPercent) / ( (Float)(2) )),null());
            					}
            					else {
HXLINE( 455)						this->_timer = ::flixel::FlxG_obj::random->_hx_float(((-(this->eraseDelay) * this->_typeVarPercent) / ( (Float)(2) )),((this->eraseDelay * this->_typeVarPercent) / ( (Float)(2) )),null());
            					}
            				}
            				else {
HXLINE( 460)					 ::flixel::addons::text::FlxTypeText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 460)					_hx_tmp->_timer = ::hx::Mod(_hx_tmp->_timer,this->delay);
            				}
HXLINE( 463)				bool _hx_tmp;
HXDLIN( 463)				if (::hx::IsNotNull( this->sounds )) {
HXLINE( 463)					_hx_tmp = !(this->useDefaultSound);
            				}
            				else {
HXLINE( 463)					_hx_tmp = false;
            				}
HXDLIN( 463)				if (_hx_tmp) {
HXLINE( 465)					if (!(this->finishSounds)) {
HXLINE( 467)						int _g = 0;
HXDLIN( 467)						::Array< ::Dynamic> _g1 = this->sounds;
HXDLIN( 467)						while((_g < _g1->length)){
HXLINE( 467)							 ::flixel::_hx_system::FlxSound sound = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN( 467)							_g = (_g + 1);
HXLINE( 469)							sound->cleanup(sound->autoDestroy,true);
            						}
            					}
HXLINE( 473)					::flixel::FlxG_obj::random->getObject_flixel_system_FlxSound(this->sounds,null(),null(),null())->play(!(this->finishSounds),null(),null());
            				}
            				else {
HXLINE( 475)					if (this->useDefaultSound) {
HXLINE( 477)						this->_sound->play(!(this->finishSounds),null(),null());
            					}
            				}
            			}
            		}
HXLINE( 483)		::String _hx_tmp5 = this->prefix;
HXDLIN( 483)		::flixel::addons::text::FlxTypeText_obj::helperString = (_hx_tmp5 + this->_finalText.substr(0,this->_length));
HXLINE( 486)		if (this->showCursor) {
HXLINE( 488)			 ::flixel::addons::text::FlxTypeText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 488)			_hx_tmp->_cursorTimer = (_hx_tmp->_cursorTimer + elapsed);
HXLINE( 491)			bool isBreakLine = ((this->prefix + this->_finalText).charAt(::flixel::addons::text::FlxTypeText_obj::helperString.length) == HX_("\n",0a,00,00,00));
HXLINE( 493)			bool _hx_tmp1;
HXDLIN( 493)			if ((this->_cursorTimer > (this->cursorBlinkSpeed / ( (Float)(2) )))) {
HXLINE( 493)				_hx_tmp1 = !(isBreakLine);
            			}
            			else {
HXLINE( 493)				_hx_tmp1 = false;
            			}
HXDLIN( 493)			if (_hx_tmp1) {
HXLINE( 495)				 ::Dynamic _hx_tmp = ::hx::ClassOf< ::flixel::addons::text::FlxTypeText >();
HXDLIN( 495)				::String _hx_tmp1 = ::flixel::addons::text::FlxTypeText_obj::helperString;
HXDLIN( 495)				::flixel::addons::text::FlxTypeText_obj::helperString = (_hx_tmp1 + this->cursorCharacter.charAt(0));
            			}
HXLINE( 498)			if ((this->_cursorTimer > this->cursorBlinkSpeed)) {
HXLINE( 500)				this->_cursorTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 505)		if ((::flixel::addons::text::FlxTypeText_obj::helperString != this->text)) {
HXLINE( 507)			this->set_text(::flixel::addons::text::FlxTypeText_obj::helperString);
HXLINE( 510)			bool _hx_tmp;
HXDLIN( 510)			bool _hx_tmp1;
HXDLIN( 510)			bool _hx_tmp2;
HXDLIN( 510)			if ((this->_length >= this->_finalText.length)) {
HXLINE( 510)				_hx_tmp2 = this->_typing;
            			}
            			else {
HXLINE( 510)				_hx_tmp2 = false;
            			}
HXDLIN( 510)			if (_hx_tmp2) {
HXLINE( 510)				_hx_tmp1 = !(this->_waiting);
            			}
            			else {
HXLINE( 510)				_hx_tmp1 = false;
            			}
HXDLIN( 510)			if (_hx_tmp1) {
HXLINE( 510)				_hx_tmp = !(this->_erasing);
            			}
            			else {
HXLINE( 510)				_hx_tmp = false;
            			}
HXDLIN( 510)			if (_hx_tmp) {
HXLINE( 512)				this->onComplete();
            			}
HXLINE( 516)			bool _hx_tmp3;
HXDLIN( 516)			bool _hx_tmp4;
HXDLIN( 516)			bool _hx_tmp5;
HXDLIN( 516)			if ((this->_length == 0)) {
HXLINE( 516)				_hx_tmp5 = this->_erasing;
            			}
            			else {
HXLINE( 516)				_hx_tmp5 = false;
            			}
HXDLIN( 516)			if (_hx_tmp5) {
HXLINE( 516)				_hx_tmp4 = !(this->_typing);
            			}
            			else {
HXLINE( 516)				_hx_tmp4 = false;
            			}
HXDLIN( 516)			if (_hx_tmp4) {
HXLINE( 516)				_hx_tmp3 = !(this->_waiting);
            			}
            			else {
HXLINE( 516)				_hx_tmp3 = false;
            			}
HXDLIN( 516)			if (_hx_tmp3) {
HXLINE( 518)				this->onErased();
            			}
            		}
HXLINE( 522)		this->super::update(elapsed);
            	}


void FlxTypeText_obj::skip(){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_531_skip)
HXDLIN( 531)		bool _hx_tmp;
HXDLIN( 531)		if (!(this->_erasing)) {
HXDLIN( 531)			_hx_tmp = this->_waiting;
            		}
            		else {
HXDLIN( 531)			_hx_tmp = true;
            		}
HXDLIN( 531)		if (_hx_tmp) {
HXLINE( 533)			this->_length = 0;
HXLINE( 534)			this->_waiting = false;
            		}
            		else {
HXLINE( 536)			if (this->_typing) {
HXLINE( 538)				this->_length = this->_finalText.length;
            			}
            		}
            	}
...
void FlxTypeText_obj::loadDefaultSound(){
            	HX_GC_STACKFRAME(&_hx_pos_09182b6b580f8cf2_545_loadDefaultSound)
HXDLIN( 545)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 545)		this->_sound = _hx_tmp->load( ::flixel::addons::text::TypeSound_obj::__alloc( HX_CTX ,null(),null()),null(),null(),null(),null(),null(),null(),null(),null());
            	}
