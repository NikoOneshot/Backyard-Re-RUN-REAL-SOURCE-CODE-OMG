...
HX_LOCAL_STACK_FRAME(_hx_pos_4abb795b407cd203_124_updateOptions,"ResetScoreSubState","updateOptions",0xb4a4f91b,"ResetScoreSubState.updateOptions","ResetScoreSubState.hx",124,0x6a59588a)
...
HXLINE(  34)		name = (name + ((HX_(" (",08,1c,00,00) + ::CoolUtil_obj::difficultyStuff->__get(difficulty)->__GetItem(0)) + HX_(")?",f6,23,00,00)));
...
HXLINE(  43)		text->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
HXLINE(  48)		text1->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  49)		if ((week == -1)) {
...
HXLINE(  63)		this->yesText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
HXLINE(  67)		this->noText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
HXDLIN(  96)						if ((this->song == HX_("spamophobia",a9,a3,8e,47))) {
HXLINE(  96)							_hx_tmp = (this->difficulty == 2);
            						}
            						else {
HXLINE(  96)							_hx_tmp = false;
            						}
HXLINE(  99)						bool _hx_tmp1;
HXDLIN(  99)						if ((this->song == HX_("spamophobia",a9,a3,8e,47))) {
HXLINE(  99)							_hx_tmp1 = (this->difficulty == 1);
            						}
            						else {
HXLINE(  99)							_hx_tmp1 = false;
            						}
HXLINE( 102)						bool _hx_tmp2;
HXDLIN( 102)						if ((this->song == HX_("Spamophobia",89,3b,c1,2b))) {
HXLINE( 102)							_hx_tmp2 = (this->difficulty == 2);
            						}
            						else {
HXLINE( 102)							_hx_tmp2 = false;
            						}
HXLINE( 105)						bool _hx_tmp3;
HXDLIN( 105)						if ((this->song == HX_("Spamophobia",89,3b,c1,2b))) {
HXLINE( 105)							_hx_tmp3 = (this->difficulty == 1);
            						}
            						else {
...
HXLINE( 109)						::Highscore_obj::resetWeek(::WeekData_obj::weeksList->__get(this->week),this->difficulty);
HXLINE( 110)						bool _hx_tmp;
HXDLIN( 110)						if ((this->week == 3)) {
HXLINE( 110)							_hx_tmp = (this->difficulty == 1);
            						}
            						else {
HXLINE( 110)							_hx_tmp = false;
            						}
HXLINE( 113)						bool _hx_tmp1;
HXDLIN( 113)						if ((this->week == 3)) {
HXLINE( 113)							_hx_tmp1 = (this->difficulty == 2);
            						}
            						else {
...
HXLINE( 118)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 118)				_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),1,null(),null(),null(),null());
...
void ResetScoreSubState_obj::updateOptions(){
            	HX_STACKFRAME(&_hx_pos_4abb795b407cd203_124_updateOptions)
HXLINE( 125)		::Array< Float > scales = ::Array_obj< Float >::fromData( _hx_array_data_9ecb92b4_4,2);
HXLINE( 126)		::Array< Float > alphas = ::Array_obj< Float >::fromData( _hx_array_data_9ecb92b4_5,2);
HXLINE( 127)		int confirmInt;
HXDLIN( 127)		if (this->onYes) {
HXLINE( 127)			confirmInt = 1;
            		}
            		else {
HXLINE( 127)			confirmInt = 0;
            		}
HXLINE( 129)		this->yesText->set_alpha(alphas->__get(confirmInt));
HXLINE( 130)		this->yesText->scale->set(scales->__get(confirmInt),scales->__get(confirmInt));
HXLINE( 131)		this->noText->set_alpha(alphas->__get((1 - confirmInt)));
HXLINE( 132)		this->noText->scale->set(scales->__get((1 - confirmInt)),scales->__get((1 - confirmInt)));
HXLINE( 133)		if ((this->week == -1)) {
HXLINE( 133)			this->icon->animation->_curAnim->set_curFrame(confirmInt);
            		}
            	}
