...
HXLINE(  43)		this->offset->set(10,10);
...
HXDLIN(  51)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(skin);
...
HXLINE(  51)			 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(skin);
HXDLIN(  51)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  51)				_hx_tmp = imageToReturn;
            			}
            			else {
HXLINE(  51)				_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
            		}
