...
HX_DECLARE_STACK_FRAME(_hx_pos_4e288e2989890fc6_39_new)
...
HXLINE(  60)		( ( ::Song)(__this) )->disableGhostTapping = false;
HXLINE(  58)		( ( ::Song)(__this) )->player3 = HX_("gf",1f,5a,00,00);
HXLINE(  57)		( ( ::Song)(__this) )->player2 = HX_("dad",47,36,4c,00);
HXLINE(  56)		( ( ::Song)(__this) )->player1 = HX_("bf",c4,55,00,00);
HXLINE(  48)		( ( ::Song)(__this) )->speed = ((Float)1);
HXLINE(  44)		( ( ::Song)(__this) )->needsVoices = true;
HXLINE(  64)		( ( ::Song)(__this) )->song = song;
HXLINE(  65)		( ( ::Song)(__this) )->notes = notes;
HXLINE(  66)		( ( ::Song)(__this) )->bpm = bpm;
            	}
