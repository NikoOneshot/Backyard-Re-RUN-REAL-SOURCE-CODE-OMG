...
class HXCPP_CLASS_ATTRIBUTES Highscore_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::haxe::ds::StringMap weekScoresDiff;
		...
		static void saveWeekScoreDiff(::String week,::hx::Null< int >  score);
		static ::Dynamic saveWeekScoreDiff_dyn();
		...
		static void setWeekScoreDiff(::String week,int score);
		static ::Dynamic setWeekScoreDiff_dyn();
		...
		static ::String formatSongDiff(::String song);
		static ::Dynamic formatSongDiff_dyn();
