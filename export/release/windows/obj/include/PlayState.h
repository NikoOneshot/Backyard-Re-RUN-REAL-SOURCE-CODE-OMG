...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static  ::WiggleEffect the3DWorldEffect;
		static  ::WiggleEffect the3DWorldEffectWavy;
		static  ::PulseEffect wavyShader;
		static bool activeWavy;
		static  ::PulseEffect screenshader;
		...
		bool isCameraOnForcedPos;
		 ::flixel::util::FlxSave noteSaveHa;
		...
		Float GF_X;
		Float GF_Y;
		::String randomBotplayText;
		 ::flixel::tweens::FlxTween jumpscareTween;
		 ...
		 ::flixel::addons::effects::chainable::FlxGlitchEffect _glitch;
		 ::flixel::addons::effects::chainable::FlxEffectSprite _effectSprite;
		bool botplayUsed;
		int nightColor;
		int hadephobiaColor;
		...
		Float botplaySine;
		 ...
		 ::flixel::text::FlxText screwYouTxt;
		 ::flixel::text::FlxText watermarkTxt;
		bool ghostTappersOff;
		bool heyStopTrying;
		bool planetSpawned;
		 ::HealthIcon iconP1;
		 ::HealthIcon iconP2;
		...
		::Array< ::String > windowMovingSongs;
		...
		int badCounter;
		int shitCounter;
		 ::flixel::addons::effects::chainable::FlxGlitchEffect glitchyEffect;
		 ::flixel::text::FlxText sickCounterTxt;
		 ::flixel::text::FlxText goodCounterTxt;
		 ::flixel::text::FlxText badCounterTxt;
		 ::flixel::text::FlxText shitCounterTxt;
		 ::flixel::text::FlxText comboCounterTxt;
		 ::flixel::text::FlxText totalNotesTxt;
		int tnh;
		int disableTheTextAt;
		bool textIsGoing;
		int getTheBotplayText;
		::Array< ::String > theListBotplay;
		::Array< ::String > textStuffLol;
		void create();
