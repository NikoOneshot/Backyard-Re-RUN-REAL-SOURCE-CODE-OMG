...
class HXCPP_CLASS_ATTRIBUTES ChartingState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static int GRID_SIZE;
		 ...
		 ::flixel::ui::FlxButton saveValue1;
		 ::flixel::ui::FlxButton saveValue2;
		::cpp::VirtualArray eventStuff;
		 ::openfl::net::FileReference _file;
		 ::flixel::addons::ui::FlxUITabMenu UI_box;
		 ::flixel::text::FlxText save1Val;
		 ::flixel::text::FlxText save2Val;
		 ::FlxUIDropDownMenuCustom preset1;
		 ::FlxUIDropDownMenuCustom preset2;
		 ::flixel::addons::ui::FlxUIInputText event7InputText;
		...
		void create();
		 ...
		 ::flixel::addons::ui::FlxUIInputText notePlayerSkinInputText;
		 ::flixel::addons::ui::FlxUIInputText creditInputText;
		 ::flixel::addons::ui::FlxUIInputText screwYouInputText;
		...
		::Dynamic addNoteUI_dyn();
		 ...
		 ::FlxUIDropDownMenuCustom event7DropDown;
		 ::flixel::text::FlxText descText;
		void addEventsUI();
		::Dynamic addEventsUI_dyn();

		void reloadEventUI();
		::Dynamic reloadEventUI_dyn();
