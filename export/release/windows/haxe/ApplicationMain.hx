...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("StridentEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("StridentEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "32";
		app.meta["company"] = "Strident Engine";
		app.meta["file"] = "StridentEngine";
		app.meta["name"] = "Friday Night Funkin': Backyard Re-run (SE)";
		app.meta["packageName"] = "com.delta.stridentengine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Backyard Re-run (SE)",
			width: 1280,
			x: null,
			y: null,
		};
